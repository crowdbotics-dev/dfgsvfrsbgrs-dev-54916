...
## Project Structure
    ...
    ├── dfgsvfrsbgrs_dev_54916  # Django project configurations
...
1. Clone this repo and `cd dfgsvfrsbgrs_dev_54916`
...
2. Clone this repo and `cd dfgsvfrsbgrs_dev_54916`
